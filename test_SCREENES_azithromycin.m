...
%% Date: 2024-01-26
%% This script is to reproduce 1H-1H symmetrical spectra reconstruction using SCREENES-hard and SCREENES-soft.
...
figure,contour(ppm1,ppm2,Rec_X_Symetric,linspace(0,1,150));
set (gca,'xdir','reverse','ydir','reverse','box','on','linewidth',1.5,'fontsize',14,'fontname','Calibri','fontweight','bold');
