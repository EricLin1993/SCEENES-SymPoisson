...
%% (Random, Sym Random, 2D Poisson and Sym 2D Poisson sampling schedules) by SCREENES-hard, using
...
save('SCREENES_data.mat','Mean_DiaRlne','Mean_CroRlne','Std_CroRlne','Std_DiaRlne')